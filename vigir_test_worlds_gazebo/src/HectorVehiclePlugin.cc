...
////////////////////////////////////////////////////////////////////////////////
// Constructor
HectorVehiclePlugin::HectorVehiclePlugin()
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetVehicleState(double _handWheelPosition,
                                       double _gasPedalPosition,
                                       double _brakePedalPosition,
                                       double _handBrakePosition,
                                   HectorVehiclePlugin::KeyType _key,
                                   HectorVehiclePlugin::DirectionType _direction)
{
...
////////////////////////////////////////////////////////////////////////////////
HectorVehiclePlugin::DirectionType HectorVehiclePlugin::GetDirectionState()
{
  return this->directionState;
}

////////////////////////////////////////////////////////////////////////////////
HectorVehiclePlugin::KeyType HectorVehiclePlugin::GetKeyState()
{
  return this->keyState;
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetDirectionState(
        HectorVehiclePlugin::DirectionType _direction)
{
  this->directionState = _direction;
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetKeyOff()
{
  this->keyState = OFF;
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetKeyOn()
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetGasTorqueMultiplier()
{
  if (this->keyState == ON)
  {
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetHandBrakeState(double _position)
{
  double min, max;
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetHandBrakeLimits(double &_min, double &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetHandBrakeLimits(double &_min, double &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetHandBrakeState()
{
  return this->handBrakeState;
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetHandWheelState(double _position)
{
  math::Angle min, max;
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetHandWheelLimits(const math::Angle &_min,
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetHandWheelLimits(math::Angle &_min, math::Angle &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetHandWheelState()
{
  return this->handWheelState;
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::UpdateHandWheelRatio()
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetHandWheelRatio()
{
  return this->steeringRatio;
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetSteeredWheelState(double _position)
{
  this->SetHandWheelState(_position / this->steeringRatio);
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetSteeredWheelLimits(const math::Angle &_min,
                                         const math::Angle &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetSteeredWheelState()
{
    return 0.5*(flSteeringState + frSteeringState);
}

////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetSteeredWheelLimits(math::Angle &_min,
  math::Angle &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetGasPedalState(double _position)
{
  double min, max;
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetGasPedalLimits(double _min, double _max)
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetGasPedalLimits(double &_min, double &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetGasPedalState()
{
  return this->gasPedalState;
}

////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetGasPedalPercent()
{
  double min, max;
  this->GetGasPedalLimits(min, max);
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetBrakePedalPercent()
{
  double min, max;
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetHandBrakePercent()
{
  double min, max;
  this->GetHandBrakeLimits(min, max);
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::UpdateHandBrakeTime()
{
  this->handBrakeTime = this->world->GetSimTime();
}

////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetFNRSwitchPercent()
{
  double min, max;
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetFNRSwitchLimits(double &_min, double &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::UpdateFNRSwitchTime()
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetBrakePedalState(double _position)
{
  double min, max;
  this->GetBrakePedalLimits(min, max);
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::SetBrakePedalLimits(double _min, double _max)
{
...
////////////////////////////////////////////////////////////////////////////////
void HectorVehiclePlugin::GetBrakePedalLimits(double &_min, double &_max)
{
...
////////////////////////////////////////////////////////////////////////////////
double HectorVehiclePlugin::GetBrakePedalState()
{
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void HectorVehiclePlugin::Load(physics::ModelPtr _parent,
                                 sdf::ElementPtr _sdf)
{
  // Get the world name.
  ...
  unsigned int id = 0;
  this->flWheelRadius = HectorVehiclePlugin::get_collision_radius(
                          this->flWheelJoint->GetChild()->GetCollision(id));
  this->frWheelRadius = HectorVehiclePlugin::get_collision_radius(
                          this->frWheelJoint->GetChild()->GetCollision(id));
  this->blWheelRadius = HectorVehiclePlugin::get_collision_radius(
                          this->blWheelJoint->GetChild()->GetCollision(id));
  this->brWheelRadius = HectorVehiclePlugin::get_collision_radius(
  ...
  math::Vector3 flCenterPos = HectorVehiclePlugin::get_collision_position(
                                this->flWheelJoint->GetChild(), id);
  math::Vector3 frCenterPos = HectorVehiclePlugin::get_collision_position(
                                this->frWheelJoint->GetChild(), id);
  math::Vector3 blCenterPos = HectorVehiclePlugin::get_collision_position(
                                this->blWheelJoint->GetChild(), id);
  math::Vector3 brCenterPos = HectorVehiclePlugin::get_collision_position(
  ...
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&HectorVehiclePlugin::UpdateStates, this));
...
void HectorVehiclePlugin::UpdateStates()
{
...
double HectorVehiclePlugin::get_collision_radius(physics::CollisionPtr _coll)
{
...
math::Vector3 HectorVehiclePlugin::get_collision_position(physics::LinkPtr _link,
                                                       unsigned int _id)
{
...
GZ_REGISTER_MODEL_PLUGIN(HectorVehiclePlugin)
}
