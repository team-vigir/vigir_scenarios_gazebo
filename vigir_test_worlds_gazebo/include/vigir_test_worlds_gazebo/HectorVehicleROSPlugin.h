...
#ifndef GAZEBO_HECTOR_VEHICLE_ROS_PLUGIN_HH
#define GAZEBO_HECTOR_VEHICLE_ROS_PLUGIN_HH
...
namespace gazebo
{
  class HectorVehicleROSPlugin: public HectorVehiclePlugin
  {
    /// \brief Constructor.
    public: HectorVehicleROSPlugin();

    /// \brief Destructor.
    public: virtual ~HectorVehicleROSPlugin();
