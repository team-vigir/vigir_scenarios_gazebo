 ...
 *
*/
#ifndef GAZEBO_HECTOR_VEHICLE_PLUGIN_HH
#define GAZEBO_HECTOR_VEHICLE_PLUGIN_HH
...
namespace gazebo
{
  /// \addtogroup hector_plugin
  /// \{
  class HectorVehiclePlugin : public ModelPlugin
  {
    /// \enum DirectionType
    ...
    /// \brief Constructor.
    public: HectorVehiclePlugin();

    /// \brief Destructor.
    public: virtual ~HectorVehiclePlugin();
    ...
    /// \brief Sets HECTOR Vehicle control inputs, the vehicle internal model
